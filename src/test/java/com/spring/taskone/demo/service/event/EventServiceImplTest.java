...
class EventServiceImplTest {
    ...
    void shouldGetEventById() {
        ...
        Optional<Event> result = testingInstance.getEventById(EVENT_ID);

        assertThat(result.isPresent(), is(Boolean.TRUE));
        assertThat(result.get().getId(), is(EVENT_ID));
    }
    ...
    void shouldGetEventsByTitle() {
        ...
        when(eventRepository.findByTitle(EVENT_TITLE, PAGE_SIZE, PAGE_NUMBER)).thenReturn(eventList);
    ...
    void shouldGetEventsForDay() {
        ...
        when(eventRepository.findByDay(EVENT_DATE, PAGE_SIZE, PAGE_NUMBER)).thenReturn(eventList);
